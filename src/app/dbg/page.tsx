  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
          <div>
            <div className="inline-block bg-green-500/20 text-green-400 text-xs font-bold px-2 py-1 rounded mb-2">
              DỮ LIỆU THỰC TỪ GOOGLE ANALYTICS 4
            </div>
            <h1 className="text-3xl font-bold text-orange-400">
              CUUHODAUIN.COM &mdash; ANALYTICS DASHBOARD
            </h1>
            <p className="text-slate-400 mt-1">
              Báo cáo hiệu suất lượt truy cập & nội dung trang web (Client Fetch)
            </p>
          </div>
        ...
        {loading ? (
          <div className="text-center py-20 text-slate-400">Đang tải dữ liệu từ Google Analytics...</div>
        ) : error ? (
